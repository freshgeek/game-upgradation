...
export function encodeLoginRsp(message: LoginRsp): Uint8Array {
  let bb = popByteBuffer();
  _encodeLoginRsp(message, bb);
  return toUint8Array(bb);
}

function _encodeLoginRsp(message: LoginRsp, bb: ByteBuffer): void {
...
export function decodeLoginRsp(binary: Uint8Array): LoginRsp {
  return _decodeLoginRsp(wrapByteBuffer(binary));
}

function _decodeLoginRsp(bb: ByteBuffer): LoginRsp {
  let message: LoginRsp = {} as any;
