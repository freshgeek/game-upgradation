System.register(["cc"], function (_export, _context) {
  ...
  function _encodeExternalMessage(message, bb) {
    ...
    var $protocolSwitch = message.protocolSwitch;
    ...
    var $responseStatus = message.responseStatus;
  ...
  function _encodeIntValueList(message, bb) {
    ...
    var array$values = message.values;
  ...
  function _decodeIntValueList(bb) {
    ...
    end_of_message: while (!isAtEnd(bb)) {
      ...
      switch (tag >>> 3) {
        ...
        case 1:
          {
            var values = message.values || (message.values = []);
  ...
  function _encodeIntListPb(message, bb) {
    ...
    var array$intValues = message.intValues;

    if (array$intValues !== undefined) {
      var packed = popByteBuffer();

      for (var value of array$intValues) {
        writeVarint32ZigZag(packed, value);
      }
  ...
  function _decodeIntListPb(bb) {
    ...
    end_of_message: while (!isAtEnd(bb)) {
      ...
      switch (tag >>> 3) {
        ...
        case 1:
          {
            var values = message.intValues || (message.intValues = []);
  ...
  function _encodeLongPb(message, bb) {
    ...
    var $longValue = message.longValue;
  ...
  function _encodeLongListPb(message, bb) {
    ...
    var array$longValues = message.longValues;

    if (array$longValues !== undefined) {
      var packed = popByteBuffer();

      for (var value of array$longValues) {
        writeVarint64ZigZag(packed, value);
      }
  ...
  function _decodeLongListPb(bb) {
    ...
    end_of_message: while (!isAtEnd(bb)) {
      ...
      switch (tag >>> 3) {
        ...
        case 1:
          {
            var values = message.longValues || (message.longValues = []);
