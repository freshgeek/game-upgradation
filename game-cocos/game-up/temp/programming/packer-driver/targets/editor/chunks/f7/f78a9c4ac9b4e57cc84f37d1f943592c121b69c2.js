System.register(["cc"], function (_export, _context) {
  ...
  function encodeLoginReq(message) {
  ...
  function _encodeLoginReq(message, bb) {
  ...
  function decodeLoginReq(binary) {
    return _decodeLoginReq(wrapByteBuffer(binary));
  }

  function _decodeLoginReq(bb) {
    let message = {};
  ...
  function encodeLoginRsp(message) {
    let bb = popByteBuffer();

    _encodeLoginRsp(message, bb);

    return toUint8Array(bb);
  }

  function _encodeLoginRsp(message, bb) {
  ...
  function decodeLoginRsp(binary) {
    return _decodeLoginRsp(wrapByteBuffer(binary));
  }

  function _decodeLoginRsp(bb) {
    let message = {};
  ...
  function encodeUserInfo(message) {
    let bb = popByteBuffer();
  ...
  function _encodeUserInfo(message, bb) {
    ...
    } // optional int32 statusField = 8;


    let $statusField = message.statusField;

    if ($statusField !== undefined) {
      writeVarint32(bb, 64);
      writeVarint64(bb, intToLong($statusField));
    }
  }

  function decodeUserInfo(binary) {
  ...
  function _decodeUserInfo(bb) {
    ...
    end_of_message: while (!isAtEnd(bb)) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          {
            message.statusField = readVarint32(bb);
            break;
          }
  ...
  _export({
    ...
    decodeLoginReq: decodeLoginReq,
    encodeLoginRsp: encodeLoginRsp,
    decodeLoginRsp: decodeLoginRsp,
    encodeUserInfo: encodeUserInfo,
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7497arM3E1F07uUyIe1HRXZ", "User", undefined);
...
//# sourceMappingURL=f78a9c4ac9b4e57cc84f37d1f943592c121b69c2.js.map