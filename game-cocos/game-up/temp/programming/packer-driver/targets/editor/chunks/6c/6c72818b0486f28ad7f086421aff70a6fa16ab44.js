  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", SocketClient = class SocketClient {
        ...
        //接收缓冲
        async connect(ws = (_crd && SysConfig === void 0 ? (_reportPossibleCrUseOfSysConfig({
          error: Error()
        ...
        onmessage(event) {
          ...
          let recvData = new Uint8Array(event.data);
          (_crd && LogUtils === void 0 ? (_reportPossibleCrUseOfLogUtils({
            error: Error()
          }), LogUtils) : LogUtils).log("recvData", recvData);
          let data = (_crd && decodeExternalMessage === void 0 ? (_reportPossibleCrUseOfdecodeExternalMessage({
            error: Error()
