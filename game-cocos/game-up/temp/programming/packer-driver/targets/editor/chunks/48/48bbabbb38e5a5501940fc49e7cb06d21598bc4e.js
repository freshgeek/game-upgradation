  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", SendMgr = class SendMgr {
        static LoginVerify(data = null) {
          let msg = (_crd && encodeLoginReq === void 0 ? (_reportPossibleCrUseOfencodeLoginReq({
            error: Error()
        ...
        static send(mergeCmd, data, cmdCode = 1, protocolSwitch = 0) {
          let msg = {
            cmdCode: cmdCode,
